...
from alab_management.device_manager.base_device import get_all_devices
from alab_management.device_manager.device_view import DeviceView
from alab_management.sample_manager.sample_view import SampleView
...
def setup_from_device_def():
    ...
    DeviceView().add_devices_to_db(devices)
    SampleView().add_sample_positions_to_db([sample_pos for device in devices

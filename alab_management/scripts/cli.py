...
def cleanup_lab_cli(all_collections: bool, _force_i_know_its_dangerous: bool, database_name: str):
    """Clean up the database."""
    if cleanup_lab(all_collections, _force_i_know_its_dangerous, database_name=database_name):
        click.echo("Done")
    else:
        click.echo("Stopped")
